...
AlertDialog stickerGenerateAlertDialogSecondImageOfOd() {
  return AlertDialog(
      scrollable: true,
                  ...
                  return Column(
                      ...
                      children: [
                        ...
                        Obx(() =>  Container(
                          ...
                          child: GridView.builder(
                              ...
                              itemBuilder: (BuildContext ctx, index) {
                                return  InkWell(
                                    onTap: () {
                                      controller.selectedStickerSecondImageOfOD = controller.stickersDataList[index].stickerImage;
                                      controller.selectedIndexOfStickerSecondImageOfOD = index;
                                      controller.update();
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: Colors.transparent,
                                        border: controller.selectedIndexOfStickerSecondImageOfOD == index ? Border.all(color: redColor,width: 1) : Border.all(color: Colors.transparent,width: 1),
                                        borderRadius: controller.selectedIndexOfStickerSecondImageOfOD == index ? BorderRadius.circular(20.r) : BorderRadius.circular(0.r),
                        ...
                        commonButton(
                            buttonName: "Done",
                            onTap: (){
                              controller.addNewStickerSecondImageOfOD();
                            },
