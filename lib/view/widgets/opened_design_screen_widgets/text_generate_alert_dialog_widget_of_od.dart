...
AlertDialog textGenerateAlertDialogWidgetOfOd() {
  return AlertDialog(
      scrollable: true,
              ...
              builder: (controller) {
                return Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        controller: controller.textControllerOfOd,
                                  ...
                                  Container(
                                    ...
                                    child: GridView.builder(
                                        ...
                                        itemBuilder: (BuildContext ctx, index) {
                                          return  InkWell(
                                              onTap: () {
                                                controller.colorOfOd = controller.colorsListOfOd[index].color;
                                                controller.selectedIndexOfColorOfOd = index;
                                                controller.update();
                                              },
                                              child: Container(
                                                height: 170.w,
                                                ...
                                                decoration: BoxDecoration(
                                                    color: Colors.transparent,
                                                    border: controller.selectedIndexOfColorOfOd == index ? Border.all(color: redColor,width: 1) : Border.all(color: Colors.transparent,width: 1),
                                                    borderRadius: controller.selectedIndexOfColorOfOd == index ? BorderRadius.circular(20.r) : BorderRadius.circular(0.r),
                                    ...
                                    child: GridView.builder(
                                        ...
                                        itemBuilder: (BuildContext ctx, index) {
                                          return  Padding(
                                            ...
                                            child: InkWell(
                                                onTap: () {
                                                  controller.fontFamilyOfOd = controller.fontFamilyListOfOD[index].name;
                                                  controller.selectedIndexOfFontOfOd = index;
                                                  controller.update();
                                                },
                                                child: Container(
                                                  decoration: BoxDecoration(
                                                    color: whiteColor,
                                                    border: controller.selectedIndexOfFontOfOd == index ? Border.all(color: redColor,width: 1) : Border.all(color: Colors.transparent,width: 1),
