...
AlertDialog textGenerateAlertDialogWidgetSecondImage() {
  return AlertDialog(
      scrollable: true,
                ...
                builder: (controller) {
                  return Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          controller: controller.textControllerForSecondImage,
                              ...
                              Container(
                                ...
                                child: GridView.builder(
                                    ...
                                    itemBuilder: (BuildContext ctx, index) {
                                      return  InkWell(
                                          onTap: () {
                                            controller.colorSecondImage = controller.colorsList[index].color;
                                            controller.selectedIndexOfColorSecondImage = index;
                                            controller.update();
                                          },
                                          child: Container(
                                            height: 170.w,
                                            ...
                                            decoration: BoxDecoration(
                                                color: Colors.transparent,
                                                border: controller.selectedIndexOfColorSecondImage == index ? Border.all(color: redColor,width: 1) : Border.all(color: Colors.transparent,width: 1),
                                                borderRadius: controller.selectedIndexOfColorSecondImage == index ? BorderRadius.circular(20.r) : BorderRadius.circular(0.r),
                                ...
                                child: GridView.builder(
                                    ...
                                    itemBuilder: (BuildContext ctx, index) {
                                      return  Padding(
                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            controller.fontFamilySecImage = controller.fontFamilyList[index].name;
                                            controller.selectedIndexOfFontSecImage = index;
                                            controller.update();
                                          },
                                          child: Container(
                                            decoration: BoxDecoration(
                                              color: whiteColor,
                                              border: controller.selectedIndexOfFontSecImage == index ? Border.all(color: redColor,width: 1) : Border.all(color: Colors.transparent,width: 1),
